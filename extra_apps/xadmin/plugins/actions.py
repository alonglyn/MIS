...
class UpdateSelectedAction(BaseActionView):
    action_name = 'update_selected'
    description = _(u'Update selected %(verbose_name_plural)s')
    model_perm = 'change'
...
class ActionPlugin(BaseAdminPlugin):
    ...
    global_actions = [DeleteSelectedAction, UpdateSelectedAction]
