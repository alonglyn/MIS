...
这两周或许是大三上整个学期最累的两周了， 等于说是除了晚上以外的都要在机房完成任务。

### 机房的环境

人文楼三座的机房也是实验经常去的地方， 但是由于机房的电脑程序开发软件都过于老旧，即使安装了新的软件也会被回复掉， 系统性能也差，所以从来都没有使用过，一直都是自己携带个人电脑完成开发任务
...
虽然很无奈地同意了， 不过我清楚的知道就考试前学了2天的java水平，还不如说不会。 于是在实习周前的两次实验里我通过各种google、知乎，找了一个python3的django的web框架，尝试着使用他来开发。毕竟大家都经历过web实习周，至少会点web开发。

作业的时候跟着django的官方文档做了一些实验后，发现这个框架真的简单， 开箱即用， 几分钟就能完成一个可能要造大量轮子才能完成的功能。所以我决定了实习周就用这个框架进行开发，并且告知了组员。 而他们还是更愿意使用Delphi 完成作业。

好吧既然这样，  按照我原来的打算， 那只能实习周实习周的前三天，早上进行文档设计， 下午学习django开发。

最开始先指导组员看python简单的的语法， django简单的入门文档。 后来发现，学习的效率太慢了， 而且遇到各种问题， 又得问我， 不如我直接一口气教会他们得了。

在反复询问是否要学习， 并得到肯定的答复后，就开始了教学。 

我尝试在组员的基础上进行最简单的讲解， 不过虽然听懂了，但是一直到了周四， 我感觉到我不能再让我的时间一直陷在这无尽的深渊里了， 我发现要让不喜欢写代码的人理解代码逻辑， 真的是一件很难的事情。 没必要为难组员、 也为难自己。
...
不过，回想起 爱国、敬业、诚信、友善的原则。我还是将心情放了下来， 思考如何在仅剩下的几天时间里， 独自完成接下来的系统开发任务， 然后让组员测试开发好的系统，提出bug以及需求，进行增量开发。理解系统的流程， 并完善原理的文档
...
一直再思考如何用django-admin的后台来实现实时库存的查询。 
